...
class FrgOptionDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_frg_option_dialog, container, false)
    }
    ...
    override fun onAttach(context: Context) {
        ...
        if (fragment is FrgCategoryDetailsFragment) {
    ...
    companion object {
        fun newInstance() = FrgOptionDialogFragment()
    }
}
